        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              {terms ? `${terms.length} prominent concepts` : "Prominent concepts"} extracted by AI weight
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 self-start sm:self-center">
          ...
          {onNewAnalysis && (
            <button
              ...
              className="min-h-11 inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200/80 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600"
            >
